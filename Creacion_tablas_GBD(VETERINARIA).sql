...
/* Created on:     18/12/2020 11:47:13                          */
/*==============================================================*/
...
drop index MASCOTA_VETERINARIO_FK;
...
create table CLIENTE_PRODUCTO (
   ...
   constraint PK_CLIENTE_PRODUCTO primary key (CI_CLIENTE, COD_PRODUCTOS)
);
...
/*==============================================================*/
/* Index: MASCOTA_VETERINARIO_FK                                */
/*==============================================================*/
create  index MASCOTA_VETERINARIO_FK on VETERINARIO (
ID_MASCOTAS
);
...
alter table VETERINARIO
   add constraint FK_VETERINA_MASCOTA_V_MASCOTAS foreign key (ID_MASCOTAS)
      references MASCOTAS (ID_MASCOTAS)
      on delete restrict on update restrict;
